<?php
/**
 * AdminService - SSC Admins MUST use G-Suite accounts (@g.batstate-u.edu.ph)
 */
...
class AdminService {
    ...
    public function create($data) {
        ...
        // CRITICAL: Check G-Suite domain for SSC Admin
    ...
    /**
     * Check if email is BSU G-Suite account
     */
