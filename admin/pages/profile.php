...
<!-- Removed problematic modalBackdrop div that was blocking modal interactions -->

<div class="container-fluid">
    <div class="mb-4 d-flex justify-content-between align-items-center">
        <div>
            <h2 class="fw-bold text-danger"><i class="bi bi-people"></i> Admin Management</h2>
            <p class="text-muted">Manage SSC administrators (<?php echo count($admins); ?> total)</p>
        </div>
                        ...
                        <?php if (empty($admins)): ?>
                            <tr>
                                <td colspan="7" class="text-center py-5">
                                    ...
                                    <p class="text-muted mt-3 mb-2 fw-bold">No SSC Admins Found</p>
