...
// Initialize response interactions (called after content is loaded)
window.initializeResponseInteractions = function(id, type) {

  console.log('Response viewer initialized for', type, id);
};

// Check response status on page load AND after pagination changes
document.addEventListener('DOMContentLoaded', function() {
  checkAllResponseStatuses();
  
  // Listen for Bootstrap Table pagination events
  ...
  // MutationObserver as fallback to detect when table rows change
