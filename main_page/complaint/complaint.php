    ...
    <form id="complaintForm" class="form-wizard" method="POST" action="process_complaint.php" novalidate enctype="multipart/form-data">
      ...
      <div class="step-panel" id="step2">
        ...
        <div class="form-group">
          ...
          <textarea id="description" name="description" placeholder="Describe the issue in detail. Include what, when, and where it happened, and any relevant details." required></textarea>
        </div>
      ...
      <div class="step-panel" id="step3">
        ...
        <p>Upload supporting files as proof (photos, videos, documents) - Optional</p>
        ...
        <div class="form-group">
          ...
          <div class="file-upload-area" id="fileUploadArea">
            ...
            <p style="margin: 0.5rem 0 0 0; color: var(--color-gray); font-size: 0.75rem;">Supported: Images (JPG, PNG), Videos (MP4), Documents (PDF, DOC)</p>
        ...
        <p style="font-size: 0.875rem; color: var(--color-gray); margin-top: 1rem;">
          <i class="bi bi-info-circle"></i> Maximum file size: 10MB. This step is optional - you can skip it if you don't have files to attach.
        </p>
      </div>
      ...
      <div class="step-panel" id="step4">
        ...
        <div class="review-section">
          ...
          <div class="review-item">
            <span class="review-label">Attachment:</span>
            <span class="review-value" id="reviewAttachment">None</span>
          </div>
        </div>
        ...
        <div style="margin: 1.5rem 0;">
          ...
          <div class="anonymous-info" id="anonymousInfo" style="display: none;">
            ...
            <p>When anonymous, your name and contact information will not be visible to administrators. Only your complaint details will be recorded.</p>
          </div>
        </div>
        ...
        <div class="terms-section">
          ...
          <div class="terms-container">
            ...
            <ul>
              ...
              <li>You have not made false or misleading statements</li>
              <li>You understand that false complaints may result in disciplinary action</li>
              <li>Your complaint will be reviewed and addressed according to university policies</li>
              <li>You grant the university permission to share your complaint details with relevant departments for resolution</li>
      ...
      <div class="step-panel" id="step5" style="display: none;">
        <div class="success-message">
          ...
          <p style="margin-bottom: 2rem;">Thank you for your submission.<br>We will review it and keep you updated on the progress.</p>
          ...
          <div class="anonymous-notification" id="step5AnonymousAlert" style="display: none;">
            ...
            <div>
              ...
              <p style="margin: 0.25rem 0 0 0; font-size: 0.875rem;">Your name and contact information are not visible to administrators. Only your complaint details are recorded.</p>
            </div>
          </div>
          ...
          <p style="margin-top: 1rem; color: var(--color-gray);">Save this Reference ID to track your complaint status from your dashboard.</p>
        </div>
      </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      if (isset($_SESSION['complaint_success'])) {
          $complaint_id = isset($_SESSION['complaint_insert_id']) ? $_SESSION['complaint_insert_id'] : '';
          $is_anonymous = isset($_SESSION['complaint_is_anonymous']) ? ($_SESSION['complaint_is_anonymous'] ? 'true' : 'false') : 'false';
          echo "complaintForm.showSuccessStep('{$complaint_id}', {$is_anonymous});";
          unset($_SESSION['complaint_success']);
          unset($_SESSION['complaint_insert_id']);
          unset($_SESSION['complaint_is_anonymous']);
      }
      ?>
    });
  </script>
